...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Oct 2019 10:43:05 GMT -->
<head>

    <!-- Basic Page Needs
    ================================================== -->
    <title>In-demand Talents, On demand | WorkCradle</title>
    <meta charset="utf-8">
                ...
                <div class="left-side">
                    ...
                    <nav id="navigation">
                        <ul id="responsive">
                            ...
                            <li><a href="index-4.html" class="current">Home</a>
                            ...
                            <li><a href="#">Developers</a>
                                <ul class="dropdown-nav">
                                    ...
                                    <li><a href="single-job-page.html">Talent Page</a></li>
                                    <li><a href="single-task-page.html">Task Page</a></li>
                                    <li><a href="single-company-profile.html">Company Profile</a></li>
                                </ul>
                            </li>

                            <li><a href="#">Find a Talent</a>
                                <ul class="dropdown-nav">
                            ...
                            <li><a href="index-4.html" class="current">Learning Management system</a>
                                <!--<ul class="dropdown-nav">
                                    <li><a href="index-2.html">Home 1</a></li>
                                    <li><a href="index-3.html">Home 2</a></li>
                                    <li><a href="index-4.html">Home 3</a></li>
                            ...
                            <!--<li><a href="index-4.html" class="current">Questiong & Answer</a>-->
                            <!--<ul class="dropdown-nav">
                                <li><a href="index-2.html">Home 1</a></li>
                                <li><a href="index-3.html">Home 2</a></li>
                                <li><a href="index-4.html">Home 3</a></li>
                        ...
                        <a href="#" class="button ripple-effect">Questiong & Answer</a>
                        </li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="dashboard-manage-bidders.html">
                                                    ...
                                                    <span class="notification-text">
													<strong>Nelson Onyenobi</strong> placed a bid on your <span class="color">iOS App Development</span> project
												</span>
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="dashboard-manage-candidates.html">
                                                    <span class="notification-icon"><i class="icon-material-outline-group"></i></span>
                                                    <span class="notification-text">
													<strong>Obinna Olebuezi</strong> applied for a job <span class="color">Full Stack Software Engineer</span>
												</span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul>
                                            ...
                                            <li class="notifications-not-read">
                                                <a href="dashboard-messages.html">
                                                    ...
                                                    <div class="notification-text">
                                                        <strong>Nelson Onyenobi</strong>
                                                        <p class="notification-msg-text">Hi Nelson! Hate to break it to you, but I'm actually on vacation until...</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner-headline-alt">
                        ...
                        <span>We build Talents and help Businesses access the talents. In-demand Talents, On Demand</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="intro-banner-search-form margin-top-95">
                        ...
                        <div class="intro-search-field">
                            <label for ="intro-keywords" class="field-title ripple-effect">What stack do you want to learn?</label>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2>Find a Talent. <br> For any project, any time.</h2>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="section-headline margin-top-0 margin-bottom-25">
                        ...
                        <a href="freelancers-grid-layout.html" class="headline-link">Browse All Talents</a>
                    </div>
                </div>
                            ...
                            <div class="freelancer-overview">
                                <div class="freelancer-overview-inner">
                                    ...
                                    <div class="freelancer-name">
                                        <h4><a href="single-freelancer-profile.html">Emmanuel Omale <img class="flag" src="images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
                        ...
                        <div class="freelancer">
                            ...
                            <div class="freelancer-overview">
                                <div class="freelancer-overview-inner">
                                    ...
                                    <!-- Name -->
                                    <div class="freelancer-name">
                                        <h4><a href="#">Nelson Onyenobi <img class="flag" src="images/flags/de.svg" alt="" title="Germany" data-tippy-placement="top"></a></h4>
                        ...
                        <div class="freelancer">
                            ...
                            <div class="freelancer-overview">
                                <div class="freelancer-overview-inner">
                                    ...
                                    <!-- Name -->
                                    <div class="freelancer-name">
                                        <h4><a href="#">Princewill Chiaka <img class="flag" src="images/flags/pl.svg" alt="" title="Poland" data-tippy-placement="top"></a></h4>
                            ...
                            <div class="freelancer-details">
                                <div class="freelancer-details-list">
                                    <ul>
                                        <li>Location <strong><i class="icon-material-outline-location-on"></i> United States</strong></li>
                        ...
                        <div class="freelancer">
                            ...
                            <div class="freelancer-overview">
                                <div class="freelancer-overview-inner">
                                    ...
                                    <!-- Name -->
                                    <div class="freelancer-name">
                                        <h4><a href="#">Cyprian Omoh <img class="flag" src="images/flags/au.svg" alt="" title="Australia" data-tippy-placement="top"></a></h4>
                        ...
                        <div class="freelancer">
                            ...
                            <div class="freelancer-overview">
                                <div class="freelancer-overview-inner">
                                    ...
                                    <!-- Name -->
                                    <div class="freelancer-name">
                                        <h4><a href="#">Obinna Harry <img class="flag" src="images/flags/it.svg" alt="" title="Italy" data-tippy-placement="top"></a></h4>
                            ...
                            <div class="freelancer-details">
                                <div class="freelancer-details-list">
                                    <ul>
                                        <li>Location <strong><i class="icon-material-outline-location-on"></i> South Africa</strong></li>
    ...
    <div id="footer">
        ...
        <div class="footer-bottom-section">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        © 2020 <strong>CodeCradle Innovations Limited</strong>. All Rights Reserved.
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Oct 2019 10:43:45 GMT -->
</html>
